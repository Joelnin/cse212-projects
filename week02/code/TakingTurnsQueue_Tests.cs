...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The list issued was backwards.
    ...
    // Defect(s) Found: The list issued was backwards, so the name was added on the incorrect spot.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: This has a combination of not having a way to handle 0 turns correctly and the list was backwards before fixing the queue issue. 
    ...
    // Defect(s) Found: There's no action for scenarios with turns less than 0. Which should be infinite.
